...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Orlando Saraiva Jr', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('orlandosaraivajr@gmail.com', email.body)
        self.assertIn('19-99297-5416', email.body)
